...
int main(void)
{
	...
	DAQmxErrChk (DAQmxCfgSampClkTiming(AOtaskHandle,"",10000.0,DAQmx_Val_Rising,DAQmx_Val_ContSamps,1000));
	...
	GenSineWave(100000,1.0,1.0,&phase,AOdata);

	DAQmxErrChk (DAQmxWriteAnalogF64(AOtaskHandle, 100000, FALSE, 10.0, DAQmx_Val_GroupByChannel, AOdata, NULL, NULL));
