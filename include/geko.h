...
// Function to create a folder in the current directory
void createFolder(char *folderName)
{                                //-----------------------------------
    char *command = malloc(100); // allocate memory for the command
...
{          //----------------------------------
    ...
    while ((c = getopt(argc, argv, "s:i:o:h:a:")) != -1)
    {
        switch (c)
        {
        case 's':
...
{ //-------------------------------------
    ...
    printf(" -a allow specify a user notes \n");
} // end of printHelp() --------------------------------------------------------
